...
License:        GPLv3
Source0:        https://www.hepforge.org/archive/herwig/%{name}-%{version}.tar.bz2
...
Requires:       ThePEG  == 2.2.3
Requires:       ThePEG-devel  == 2.2.3
BuildRequires:  ThePEG  == 2.2.3
BuildRequires:  ThePEG-devel  == 2.2.3
