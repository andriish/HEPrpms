...
Source0:	https://gitlab.cern.ch/hepmc/HepMC3/-/archive/%{version}/%{name}-%{version}.tar.gz
...
%{_includedir}/%{name}/bxzstr/LICENSE
...
%changelog
* Mon Feb 21 2022 HepMC3 authors <hepmc-dev@cern.ch> - 3.2.5-1
...
* Tue May 26 2020 Miro HronÄ¨ok <mhroncok@redhat.com> - 3.2.1-3
