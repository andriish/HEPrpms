...
if(MLAS_AMX_SUPPORTED)
  ...
  if(UNIX AND NOT APPLE)
    if (HAS_NO_MAYBE_UNINITIALIZED)
      target_compile_options(onnxruntime_mlas PUBLIC "-Wno-maybe-uninitialized")
    endif()
  endif()
...
elseif(MSVC)
  setup_mlas_source_for_windows()
    ...
    if(X86_64 AND MLAS_SOURCE_IS_NOT_SET)
        ...
        set_source_files_properties(${mlas_platform_srcs_avx512f} PROPERTIES COMPILE_FLAGS "-mavx512f -Wno-maybe-uninitialized")
        ...
        set_source_files_properties(${mlas_platform_srcs_avx512core} PROPERTIES COMPILE_FLAGS "-mavx512bw -mavx512dq -mavx512vl -Wno-maybe-uninitialized")
