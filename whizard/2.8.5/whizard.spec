...
Requires: fastjet hoppet HepMC3 HepMC3-rootIO gosam openloops ocaml recola2 pythia8 LCIO TAUOLA
...
BuildRequires: root  python3 python3-devel  openmpi openmpi-devel noweb LCIO LCIO-devel TAUOLA TAUOLA-devel
...
%if 0%{?suse_version}
Requires: fastjet hoppet libHepMC3-1  gosam openloops ocaml  gosam recola libpythia8 LCIO  libLHAPDF TAUOLA
...
BuildRequires: root6 root6-libs root6-devel   python3-devel  openmpi openmpi-devel noweb LCIO LCIO-devel TAUOLA TAUOLA-devel
Requires: LoopTools 
