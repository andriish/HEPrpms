...
%package doc
Summary:    Documentation for Delphes.
BuildArch:    noarch

%description doc
This package provides Delphes manuals and examples.
...
%changelog
* Wed May 26 2021 Andrii Verbytskyi 3.4.3pre12
- Update to 3.4.3pre12
