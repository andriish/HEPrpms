...
template  SeriesC<qd_real> partial_amplitude_cached::eval_fn(momentum_configuration<qd_real>& mc, const vector<int>& ind,int mu_index);
template  SeriesC<dd_real> partial_amplitude_cached::eval_fn(momentum_configuration<dd_real>& mc, const vector<int>& ind,int mu_index);
template  SeriesC<double> partial_amplitude_cached::eval_fn(momentum_configuration<double>& mc, const vector<int>& ind,int mu_index);
}
}
