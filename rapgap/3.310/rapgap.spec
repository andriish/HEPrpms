...
Source0:     https://gitlab.cern.ch/jung/rapgap/-/archive/%{version}/rapgap-%{version}.tar.gz
...
%endif
%if 0%{?suse_version}
BuildRequires:  gcc-fortran  libHepMC4 libHepMC3-1   HepMC3-devel HepMC2-devel libLHAPDF LHAPDF-devel  Rivet-devel Rivet YODA YODA-devel
Requires:       gcc-fortran libHepMC4 libHepMC3-1 libLHAPDF   Rivet YODA
