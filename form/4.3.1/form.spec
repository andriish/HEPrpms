...
%if 0%{?rhel} || 0%{?fedora}
BuildRequires:  gcc-gfortran gmp-devel zlib-devel
%endif
%if 0%{?suse_version}
...
%if 0%{?rhel} || 0%{?fedora}
%configure  --with-gmp=/usr --with-zlib=/usr
%else
%configure  
%endif
make %{?_smp_mflags}
cat <<EOF > doc/doxygen/version.sh
repo_version='4.3.1'
repo_version_desc='v4.3.1'
repo_revision='v4.3.1'
repo_date='10 April 2023'
repo_major_version='4'
repo_minor_version='3'
repo_patch_version='1'
repo_version_suffix=''
EOF
