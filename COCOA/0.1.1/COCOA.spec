...
%if 0%{?rhel} || 0%{?fedora}
BuildRequires:	 expat expat-devel  xerces-c-devel xerces-c
BuildRequires:	 HepMC HepMC-devel root root-hist pythia8-devel fastjet-devel jsoncpp-devel pythia8
